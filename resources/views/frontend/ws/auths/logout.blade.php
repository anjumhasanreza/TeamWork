...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-logout-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 21:39:51 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Log Out | RAMK</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 text-center">
                                        ...
                                        <div class="mt-4 pt-2">
                                            ...
                                            <div class="mt-4">
                                                <a href="{{ asset('/signin') }}" class="btn btn-success w-100">Sign
                                                    In</a>
                                            </div>
                                        </div>
                                    </div>

...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg"
    ...
    <!-- Mirrored from themesbrand.com/velzon/html/default/auth-twostep-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 21:39:51 GMT -->

    <head>

        <meta charset="utf-8" />
        <title>Two Step Verification | RAMK</title>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4">
                                            ...
                                            <div class="mt-5 text-center">
                                                <p class="mb-0">Didn't receive a code ? <a href="{{ asset('/password/reset') }}"

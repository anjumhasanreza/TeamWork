...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 21:39:50 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Sign In | RAMK</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Sign in to continue to RAMK.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form action="{{ ('/dashboard') }}">
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="{{ asset('/password/reset') }}" class="text-muted">Forgot
                                                            password?</a>
                                                    </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Don't have an account ? <a href="{{ asset('/signup') }}"

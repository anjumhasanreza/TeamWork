...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-success-msg-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 21:39:51 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Success Message | RAMK</title>
                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 text-center">
                                        ...
                                        <div class="mt-4 pt-2">
                                            <h4>Well done !</h4>
                                            <p class="text-muted mx-4">Sign Up successfull.</p>
                                            <div class="mt-4">
                                                <a href="{{ asset('/dashboard') }}" class="btn btn-success w-100">Continue to
                                                    Dashboard</a>
                                            </div>
                                        </div>
                                    </div>

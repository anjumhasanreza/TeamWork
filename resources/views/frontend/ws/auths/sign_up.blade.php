...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signup-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 21:39:51 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Sign Up | RAMK</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Get your Free RAMK account now.</p>
                                        </div>

                                        <div class="mt-4">
                                            <form class="needs-validation" novalidate
                                                action="{{ asset('/login/successfull') }}">

                                                <div class="mb-3">
                                                    <label for="usermobile" class="form-label">Mobile <span
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Already have an account ? <a href="{{ asset('/signin') }}"

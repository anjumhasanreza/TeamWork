        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-sm-10">
                <div class="text-center mt-lg-5 pt-5">
                    <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your business with
                        <span class="text-success">RAMK </span>
                    </h1>
                    <p class="lead text-muted lh-base">RAMK is a fully responsive, multipurpose and premium
                        Bootstrap 5 Admin & Dashboard Template built in multiple frameworks.</p>
                        <!-- Bootstrap 5 Admin & Dashboard Template built in multiple frameworks.</p> -->

                    <div class="d-flex gap-2 justify-content-center mt-4">
                        <a href="{{ asset('signup') }}" class="btn btn-primary">Get Started <i

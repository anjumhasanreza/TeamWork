...
@section('title','IMS | Edit Category ')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3 ">
                                    <label class="form-label" for="category-description-input">Description</label>
                                    <input type="text" class="form-control" id="category-description-input"
                                ...
                                <div class="col-lg-6 mb-3 ">
                                    ...
                                    <input type="text" class="form-control" id="remarks-input"
                                        placeholder="Enter category's remarks">
                                </div>

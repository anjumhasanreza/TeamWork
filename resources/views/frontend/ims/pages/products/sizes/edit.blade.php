                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 mb-3 ">
                                    <!-- <div class="mb-3"> -->
                                    <label class="form-label" for="size-title-input">Size Ttile <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="size-title-input"
                                        placeholder="Enter size title">
                                </div>

                                <div class="col-lg-6 mb-3 ">
                                    <label class="form-label" for="size-description-input">Description</label>
                                    <input type="text" class="form-control" id="size-description-input"
                                        placeholder="Enter size's description">
                                </div>

                                <div class="col-lg-6 mb-3 ">
                                    <label class="form-label" for="remarks-input">Remarks</label>
                                    <input type="text" class="form-control" id="remarks-input"
                                        placeholder="Enter size's remarks">
                                </div>

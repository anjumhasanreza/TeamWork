            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Product -> UOM</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 mb-3 ">
                                    <!-- <div class="mb-3"> -->
                                    <label class="form-label" for="uom-title-input">UOM Ttile <span
                                ...
                                <div class="col-lg-6 mb-3 ">
                                    <label class="form-label" for="uom-description-input">Description</label>
                                    <input type="text" class="form-control" id="uom-description-input"
                                        placeholder="Enter uom's description">
                                </div>

                                <div class="col-lg-6 mb-3 ">
                                    <label class="form-label" for="remarks-input">Remarks</label>
                                    <input type="text" class="form-control" id="remarks-input"
                                        placeholder="Enter uom's remarks">
                                </div>

                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3 ">
                                    <label class="form-label" for="brand-description-input">Description</label>
                                    <input type="text" class="form-control" id="brand-description-input"
                                        placeholder="Enter brand's description">
                                </div>
